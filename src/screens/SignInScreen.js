...
<ScrollView style={styles.container}>
  ...
  <View style={styles.errorContainer}>
    <Text style={styles.error}>Email or Password is incorrect, check and try again</Text>
  </View>
      <View>
      <Text style={styles.formTxt}>Email</Text>
     <TextInput placeholder='john.smith@mail.com' placeholderTextColor='#a6a2a2' style={styles.input} />
      </View>
         <View>
  ...
  <Text style={{marginLeft:40, fontSize:30}} onPress={()=>{
